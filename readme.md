...
Значения `keyword` и `coupon` — пример данных, введённых пользователем (в форме они выводятся как placeholder). Приложение проверяет только то, что оба поля заполнены; фиксированной пары «логин — пароль» в нём нет.
...
|---|---|
| Всего коммитов | 4 |
| Период разработки | 10.06.2026 — 09.09.2026 |
| Ветка | main |
| Файлов под версионным контролем | 45 |
| Добавлено строк кода и документации | 4167 |
...
10.06.2026  ████████████                1   first-commit
                                            31 файл, +2474
27.06.2026  ████████████████████████    2   upd: Требования на «Хорошо»
                                            18 файлов, +1693 −4
                                            Add files via upload
09.09.2026  ████████████                1   sync: записка, диаграммы, документация

Всего: 4 коммита за 92 дня
```
...
●  — коммит      ·  — нет активности

По дням недели:  Ср — 2, Сб — 2
Пиковые часы:    02:00–05:00 и 15:00–20:00
```
...
└── Пояснительная_записка_Светлакова.docx   # Пояснительная записка
```

Каждый раздел с диаграммой содержит исходное описание и PNG-версию для просмотра на GitHub.
