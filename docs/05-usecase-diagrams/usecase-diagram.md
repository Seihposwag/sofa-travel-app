...
flowchart LR
    ...
    subgraph SYS["Travel World"]
        ...
        UC11["UC11 Редактирование профиля"]
        UC12["UC12 Работа в админ-панели"]
...
| UC11 | Редактирование профиля | Пользователь | да |
| UC12 | Работа в админ-панели | Администратор | да, плюс `is_staff` |
...
3. Система показывает форму: название, направление, описание, цена, дней, фото.
